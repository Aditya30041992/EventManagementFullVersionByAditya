interface Drivable {   
    ...
    start(): void;
    // Attempt to drive a distance. 
    //Returns true or false based on whether or not the drive was successful.
...
class Car implements Drivable {
    ...
    */
    ...
    /*
    *  Attempt to drive a distance. Returns true or false 
       based on whether or not the drive was successful.
